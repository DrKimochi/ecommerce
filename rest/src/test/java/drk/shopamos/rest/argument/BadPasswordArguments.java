...
public class BadPasswordArguments implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        ...
        return Stream.of(
                ...
                Arguments.of(PUT, GET_DELETE_UPDATE_URI, "123", "7Letter"),
                Arguments.of(PUT, GET_DELETE_UPDATE_URI, "123", "uppercase0times"),
                Arguments.of(PUT, GET_DELETE_UPDATE_URI, "123", "LOWERCASEIS0"),
                Arguments.of(PUT, GET_DELETE_UPDATE_URI, "123", "NotASingleNumber"),
                Arguments.of(PUT, GET_DELETE_UPDATE_URI, "123", "PassIsOver16Chars"));
    }
}
