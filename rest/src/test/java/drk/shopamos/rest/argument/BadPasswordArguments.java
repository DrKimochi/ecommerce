...
public class BadPasswordArguments implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) {
        ...
        return Stream.of(
                ...
                Arguments.of(PUT, UPDATE_URI, "123", "7Letter"),
                Arguments.of(PUT, UPDATE_URI, "123", "uppercase0times"),
                Arguments.of(PUT, UPDATE_URI, "123", "LOWERCASEIS0"),
                Arguments.of(PUT, UPDATE_URI, "123", "NotASingleNumber"),
                Arguments.of(PUT, UPDATE_URI, "123", "PassIsOver16Chars"));
    }
}
