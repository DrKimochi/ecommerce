...
public class ProductFindAllByAttributesArguments implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) {
        return Stream.of(
                Arguments.of(SWORD_CAT_ID, null, null, null, null, null),
                ...
                Arguments.of(null, null, null, null, BigDecimal.valueOf(1440.50), null),
                Arguments.of(null, null, null, null, null, false),
                Arguments.of(
                        SHIP_CAT_ID,
                        "MerRy",
                        "wOrthy ShIp",
                        BigDecimal.valueOf(9998.98),
                        BigDecimal.valueOf(10000.02),
                        true));
    }
}
